...
var Heart = React.createClass({
  render: function () {
    ...
    return (
      <div style={this.props.style}>
        <p style={paragraph}>
          <a target="_blank" href="https://giphy.com/gifs/excited-corgi-xT77XKxcPqxIZqUrwk"> <img style={heart} title='yay' alt='this was supposed to be a heart' src={'./heart.png'} /> </a>
        </p>
      </div>
    )
  }
